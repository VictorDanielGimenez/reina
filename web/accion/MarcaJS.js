$(function () {
    $('#form').submit(function(e) {
        ...
        if ($('#nombre').val() == "") {
            ...
            datos = {bandera: 1, marca_descri: $("#nombre").val()};
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                ...
                for (var i = 0; i < json.length; i++) {
                    dataSet.push([json[i].id_marca, json[i].marca_descri,json[i].id_marca,]);                   
                }
                console.log(dataSet);
...
$('#form_editar').submit(function(e) {
  ...
  if ($('#nombres').val() == "") {
    ...
    dato = {bandera: 2, id_marca: $("#codigo").val(),marca_descri: $("#nombres").val()};
    $.ajax({
        url: '/reina/MarcaCRTL',
      method: 'POST',
