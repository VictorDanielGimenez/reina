!(function (e, a) {
  ...
  var He =
    ...
    je = "Ene_Feb_Mar_Abr_May_Jun_Jul_Ago_Sep_Oct_Nov_Dic".split("_"),
    xe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
    Pe = ue,
    Oe = ue;
  function We(e, a) {
  ...
  var Ge = "Domingo_Lunes_Martes_Miercoles_Jueves_Viernes_Sabado".split("_"),
    Ve = "Dom_Lun_Mar_Mie_Jue_Vie_Sab".split("_"),
    Be = "Do_Lu_Ma_Mi_Ju_Vi_Sa".split("_"),
    Ke = ue,
    qe = ue,
    Ze = ue;
  function $e() {
